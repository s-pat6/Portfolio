...
export default function FloatingFooter() {
  return (
    <motion.footer
      ...
      className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 items-center gap-8 rounded-full border border-blue-200 bg-gradient-to-br from-blue-100 via-white to-indigo-100 px-12 py-5 shadow-2xl backdrop-blur-md dark:border-blue-800/50 dark:from-blue-950/80 dark:via-zinc-900/70 dark:to-indigo-950/80"
      style={{
    ...
    >
      ...
      <div className="relative group">
        ...
        <span className="pointer-events-none absolute -top-12 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-md bg-white/90 text-black px-3 py-2 text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-lg z-50 dark:bg-black/90 dark:text-white">
          LinkedIn
        </span>
      </div>
      {/* GitHub */}
